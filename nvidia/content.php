    ...
    <div class="container">
        <div class="page-content">
            ...
            <div class="hero-section">
                <div class="banner_section_content">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <h1 class="head-title text-white"> Offerta Nvidia Esclusiva <br
                                    class="d-none d-lg-block">per l’Italia 100% Bonus <a class="cursor_point"
                                    onclick="openPopup()"> (?) </a> + 20%<br class="d-none d-lg-block"> Cashback <a
                            ...
                            <p class="heroSbHead text-white">Registrati in meno di 3 minuti e inizia a fare trading con
                                una piattaforma regolamentata.</p>
                            <!-- Form Section -->
                            <section>
                                <div class="form-container">
                                    <form id="formsubmit" method="POST"
                                        class="formLead form-horizontal registration-form">
                                        ...
                                        <button type="submit" id="submit-button" class="submit-button"
                                            disabled>Registrati e inizia a fare trading</button>
                                        <span class="form_span mt-2">
                                            <b>🎁 Massimizza i tuoi premi: scambia, guadagna e sblocca i vantaggi VIP
                                                con
                                                TenTrade!</b>
                                        </span>
                                    </form>
            ...
            <p class="text-center motion_money mb-5">
                Acquista 100 azioni Nvidia oggi e ottieni un possibile profitto di <b>5,850$</b> entro la fine dell'anno
            </p>
...
<section class="whyChoose-section_main">
    <div class="container-fluid">
        <div class="whyChoose-section text-center mb-5 text-white">
            ...
            <p class="text-white">
                Non perdere l'opportunità di investire nei titoli più promettenti di NVIDIA.
            </p>
        </div>
        <div class="container">
            <div class="row gy-5">
                <div class="col-lg-6">
                    <div class="step-box d-flex flex-column text-white text-start mb-4">
                        <div class="card-text mt-3 text-white">
                            <h4 class="text-gold ">Leader nel settore dell'intelligenza artificiale e dei semiconduttori
                            </h4>
                            <p class="text-white">NVIDIA è al centro della rivoluzione dell'intelligenza artificiale e
                                fornisce chip e soluzioni avanzati utilizzati nei data center, nell'automotive, nella
                ...
                <div class="col-lg-6">
                    <div class="step-box d-flex flex-column text-white text-start mb-4">
                        <div class="card-text mt-3 text-white">
                            <h4 class="text-gold ">Dominio nel mondo dei videogiochi</h4>
                            <p class="text-white">Le GPU NVIDIA GeForce sono tra le preferite dai giocatori e dai
                                creatori di contenuti di tutto il mondo e alimentano i fiorenti settori del gaming e
                                degli eSport.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 mt-4">
                    <div class="step-box d-flex flex-column text-white text-start">
                        <div class="card-text mt-3 text-white">
                            <h4 class="text-gold ">Solide performance finanziarie
                            </h4>
                            <p class="text-white">
                                Grazie a una crescita costante e a risultati finanziari impressionanti, NVIDIA continua
                                a superare le aspettative e ad attirare l'attenzione degli investitori globali.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mt-4">
                    <div class="step-box d-flex flex-column text-white text-start">
                        <div class="card-text mt-3 text-white">
                            <h4 class="text-gold ">Espansione nei settori chiave</h4>
                            <p class="text-white">Dall'intelligenza artificiale al cloud computing, dal metaverso alle
                                auto a guida autonoma, NVIDIA è presente in ogni settore tecnologico emergente e offre
...
<section class="new_box">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2 class="py-4">
                    Come investire in Nvidia in modo semplice, veloce e sicuro
                </h2>
                <!-- <p class="mb-5">
                ...
                <div class="mb-4 d-lg-flex d-block align-items-baseline gap-3">
                    ...
                    <div>
                        <h3 class="h5 font-weight-bold">
                            Inizia a investire in Nvidia
                        </h3>
                        <p>Tutto pronto! Inizia a investire in oltre 3.000 altri asset digital</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 d-flex justify-content-center align-items-center">
                <img alt="Smartphone displaying investment app interface" class="img-fluid new_img w-100 d-none"
...
<section class="whyChoose-section_main">
    <div class="container-fluid">
        <div class="whyChoose-section text-center mb-5 text-white">
            ...
            <p class="text-white">TenTrade si impegna a proteggere i tuoi interessi attraverso le nostre solide misure
                    ...
                    <div class="step-box d-flex flex-column text-white text-start">
                        <div class="card-text mt-3 text-white">
                            ...
                            <p class="text-white">Si tratta di un processo di prelievo rapido e affidabile. Nessun
                                ritardo o fastidio: solo pagamenti sicuri e senza problemi ogni volta che ne ha i
                                bisogno!
                            </p>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="py-4 text-center">
                    Inizia a fare trading sulle azioni più di tendenza del momento Scopri le opportunità di mercato ora!
                </h2>
                <!-- <p class="mb-5">
                     Dalle nozioni di base alle strategie avanzate, eToro offre funzionalità uniche che portano il tuo portafoglio al livello successivo
                     </p> -->
    ...
    <div class="container">
        <div class="row">
            ...
            <p class="disclmber">Il trading di Forex e Contratti per Differenza (CFD) comporta un elevato livello di
                ...
                chiedi sempre una consulenza finanziaria indipendente. Le performance passate non sono indicative dei
                risultati futuri.</p>
        </div>
        <p></p>
    </div>
...
<div class="popup" id="popupModal">
    <div class="popup-content">
        ...
        <button class="close-btn" onclick="closePopup()">Vicina</button>
    </div>
</div>
...
<div class="popupp" id="popupModall">
    <div class="popup-contentt">
        <p>Rimborso accreditato a fine mese sulle perdite nette</p>
        <button class="close-btnn" onclick="closePopupp()">Vicina</button>
    </div>
</div>
