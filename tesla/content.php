    ...
    <div class="container">
        <div class="page-content">
            ...
            <div class="hero-section">
                <div class=" banner_section_content">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <h1 class="head-title text-white"> Offerta Tesla Esclusiva per l’Italia 100% Bonus <a
            ...
            <p class="text-center motion_money mb-5">
                Acquista 200 azioni Tesla oggi e ottieni un possibile profitto di <b>$36,400</b> entro la fine dell'anno
            </p>
...
<section class="whyChoose-section_main">
    <div class="container-fluid">
        <div class="whyChoose-section text-center mb-5 text-white">
            ...
            <p class="text-white">
                Non perdere l'opportunità di investire in uno dei titoli azionari più innovativi e promettenti sul
                mercato.
            </p>
        </div>
        <div class="container">
            <div class="row gy-5">
                <div class="col-lg-6">
                    <div class="step-box d-flex flex-column text-white text-start mb-4">
                        <div class="card-text mt-3 text-white">
                            <h4 class="text-gold ">Leadership nella mobilità elettrica</h4>
                            <p class="text-white">Tesla sta rivoluzionando il settore automobilistico con la sua
                                tecnologia per veicoli elettrici, superando costantemente la concorrenza.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="step-box d-flex flex-column text-white text-start mb-4">
                        <div class="card-text mt-3 text-white">
                            <h4 class="text-gold ">Crescita e redditività a lungo termine</h4>
                            <p class="text-white">Grazie alla sua storia di espansione e agli elevati margini di
                                profitto, Tesla rimane uno dei titoli azionari con il maggiore potenziale di crescita.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mt-4">
                    <div class="step-box d-flex flex-column text-white text-start">
                        <div class="card-text mt-3 text-white">
                            <h4 class="text-gold "> Innovazione in molteplici settori</h4>
                            <p class="text-white">Oltre alle automobili, Tesla sta investendo nelle energie rinnovabili,
                                nell'intelligenza artificiale e nella robotica, diversificando i suoi flussi di entrate.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mt-4">
                    <div class="step-box d-flex flex-column text-white text-start">
                        <div class="card-text mt-3 text-white">
                            <h4 class="text-gold ">Sostenibilità e futuro dell'energia</h4>
                            <p class="text-white">Investire in Tesla significa investire in un futuro più pulito e
                                sostenibile, con soluzioni che stanno trasformando il modo in cui il mondo utilizza
                                l'energia.
                            </p>
                        </div>
                    </div>
...
<section class="new_box">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2 class="py-4">
                    Come investire in Tesla in modo semplice, veloce e sicuro
                </h2>
                <!-- <p class="mb-5">
